...
const SQUAD_DEFAULTS = [
  ...
  { id: 'cm1', name: 'Luke',     num: 8,  label: 'CM', group: 'mid', x: 28, y: 55, color: '#2b5c8a', img: '/images/mary_jesus_01.jpeg', position: 'CM',  rating: 82, stats: { pace: 72, shooting: 75, passing: 82, dribbling: 78, defending: 68, physical: 76 } },
  { id: 'cm2', name: 'Andrew',   num: 6,  label: 'CM', group: 'mid', x: 50, y: 50, color: '#2b5c8a', img: '/images/index.jpeg',    position: 'CM',  rating: 79, stats: { pace: 70, shooting: 72, passing: 80, dribbling: 76, defending: 66, physical: 74 } },
  { id: 'cm3', name: 'Thomas',   num: 10, label: 'CM', group: 'mid', x: 72, y: 55, color: '#2b5c8a', img: '/images/koh-01.jpeg',     position: 'CM',  rating: 81, stats: { pace: 74, shooting: 78, passing: 84, dribbling: 80, defending: 64, physical: 72 } },
